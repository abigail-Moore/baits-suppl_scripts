...
for Group in GroupDict:
	...
	Line = ScriptFolder+"tbaits_intron_removal_shortened.py "+LLFileName+" "+DataPath+"_exons/ "+OutFilePre+"e1_ "+OGFileName+" "+AlFolder+" "+AlFilePre+" "+AlFilePost+" "+ScriptFolder2+" >> "+OutFolder+Date+"_"+OutFilePre+"contig_classif.log\n"
	Line += "date >> "+OutFolder+Date+"_"+OutFilePre+"contig_classif.log\n"
	OutScript.append(Line)
if Mode == "Parallel":
	for RoundNum in range(1,NRounds+1):
